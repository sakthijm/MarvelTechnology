...
<body>
	<sql:setDataSource var="demo" driver="com.mysql.cj.jdbc.Driver"
		url="jdbc:mysql://localhost/students" user="ruba" password="marvel123" />
	...
	<div id="updateTable" style="display: none">
		...
		Register number: <input type="text" name="regno" id="regno">
		<button onclick="getdataFunction()">FETCH</button>
		<br>
		<br>
		</form>
	</div>
